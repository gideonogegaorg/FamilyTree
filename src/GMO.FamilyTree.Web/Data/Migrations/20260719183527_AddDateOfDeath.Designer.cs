...
namespace GMO.FamilyTree.Web.Data.Migrations
{
    ...
    [Migration("20260719183527_AddDateOfDeath")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GMO.FamilyTree.Web.Data.FamilyMember", b =>
                {
                    ...
                    b.ToTable("FamilyMembers", t =>
                        {
                            t.HasCheckConstraint("CK_FamilyMember_DOD_After_DOB", "\"DOD\" IS NULL OR \"DOB\" IS NULL OR \"DOD\" >= \"DOB\"");
                        });
                });
            ...
            modelBuilder.Entity("GMO.FamilyTree.Web.Data.FamilyTreeAccess", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("FamilyTreeAccesses");
                });

            modelBuilder.Entity("GMO.FamilyTree.Web.Data.FamilyTreeInvite", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("GMO.FamilyTree.Web.Data.UserProfile", b =>
                {
                    ...
                    b.Property<int?>("TreeCardViewMode")
                        .HasColumnType("integer");
