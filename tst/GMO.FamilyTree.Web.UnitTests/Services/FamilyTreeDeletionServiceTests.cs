...
public class FamilyTreeDeletionServiceTests
{
    ...
    private static async Task<Data.FamilyTree> SeedTreeAsync(AppDbContext db, string ownerId, string name)
    {
        var tree = new Data.FamilyTree { Uid = Guid.NewGuid(), Name = name, OwnerId = ownerId };
