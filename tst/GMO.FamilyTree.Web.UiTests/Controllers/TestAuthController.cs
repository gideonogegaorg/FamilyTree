...
namespace GMO.FamilyTree.Web.UiTests.Controllers;
...
public class TestAuthController : ControllerBase
{
    ...
    [HttpGet("SignIn")]
    public async Task<IActionResult> SignIn([FromServices] GMO.FamilyTree.Web.Services.ICurrentFamilyTreeService currentTree, CancellationToken cancellationToken)
    {
